  ...
  return (
    <div>
      ...
      <Routes>
        ...
        <Route path="/card" element={ <ProtectedRoute><Cards /></ProtectedRoute>} />
        ...
        <Route path="/checking-details" element={<ProtectedRoute><CheckingDetails /></ProtectedRoute>} />
        <Route path="/saving-details" element={ <ProtectedRoute><SavingDetails /></ProtectedRoute>} />
        <Route path="/credit-details" element={ <ProtectedRoute><CreditDetails /></ProtectedRoute>} />
      </Routes>
