...
function CreditCard() {
  return (
    <main className="bg-white">
      <section className="flex bg-[url('/image/lady.svg')] max-h-6xl  bg-cover bg-center bg-blend-overlay gap-30 justify-center p-10  w-full h-[80vh] bg-[#08000ceb] min-h-[700px]  items-center px-20">
        <div className=" text-white w-[50%] max-w-2xl  ">
          ...
          <Link to={"/signup"}>
            {" "}
            <button className="flex gap-2 items-center bg-white font-medium cursor-pointer text-[#8a00c0] rounded-xl p-3 ">
