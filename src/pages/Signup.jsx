...
function Signup() {
  ...
  return (
    <main className="w-full h-screen flex gap-10">
      ...
      <section className="w-[50%]  flex flex-col justify-center items-center position-relative gap-5 overflow-y-auto">
        <h2 className="font-bold text-2xl text-[#5d2700] mt-130 mb-5">
          PNC Bank{" "}
        </h2>
        <h1 className="font-bold text-5xl text-[#cb8400] mb-5">Signup</h1>
        <form className="w-[60%] z-100" onSubmit={handleSubmit}>
          <div className="mb-5 flex gap-1 flex-col">
            <label
              htmlFor="firstName"
              className="font-bold text-[#453926] mb-1"
            >
              {" "}
              First Name
            </label>
            <div className="border bg-white border-[#727272] rounded  focus:border-[#cb8400] flex items-center">
              <i className="fa-regular fa-user text-[#595959] text-lg m-3"></i>
              <input
                type="text"
                required
          ...
          <div className="mb-5 flex gap-1 flex-col">
            <label htmlFor="lastName" className="font-bold text-[#453926] mb-1">
              {" "}
              Last Name
            </label>
            <div className="border bg-white border-[#727272] rounded  focus:border-[#cb8400] flex items-center">
          ...
          <div className="mb-5 flex gap-1 flex-col">
            ...
            <div className="border bg-white border-[#727272] rounded  focus:border-[#cb8400] flex items-center">
              <i className="fa-solid fa-phone text-[#595959] text-lg m-3"></i>
              <input
                type="phone"
                required
                onChange={handleChange}
          ...
          <div>
            <h4 className="font-semibold text-lg">Password requirements:</h4>
            <li className="text-[#595959] mb-1 list-none">
              {" "}
            ...
            <li className="text-[#595959] list-none">
              {" "}
        ...
        {message && (
          <div className="mt-5 p-3 rounded-[5px] text-center font-medium ">
            {" "}
            {message}{" "}
          </div>
        )}
        ...
        />
        <Link to={"/"}>
          <button className="hover:text-[#595959] cursor-pointer p-1 px-9  z-100 rounded-xl bg-[#d3cfad]">
            Back to home
          </button>
        </Link>
      </section>
