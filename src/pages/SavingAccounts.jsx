...
function SavingAccounts() {
  return (
    <main className="bg-white">
      <section className="flex bg-[url('/image/lady.svg')] max-h-6xl  bg-cover bg-center bg-blend-overlay gap-30 justify-center p-10  w-full h-[80vh] bg-[#040c00eb] min-h-[700px]  items-center px-20">
        <div className=" text-white w-[50%] max-w-2xl ">
          <h1 className="font-bold mb-5 text-5xl 2xl:text-6xl">
          ...
          <Link to={"/signup"}>
            {" "}
            <button className="flex gap-2 w-fit items-center bg-white font-medium cursor-pointer text-[#06c000] rounded-xl p-3 ">
        ...
        <div className="">
          {" "}
          <img src={saving} alt="" className="w-150 rounded-2xl shadow-md " />
        </div>
      </section>
      <section className="max-w-5xl mx-auto p-10">
        ...
        <section className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 gap-10 ">
          <div className="w-full p-10 border-2 border-[#cdcdcd] rounded py-15 hover:border-[#06c000] bg-white">
            <h3 className="text-2xl  font-bold text-black">Standard Savings</h3>
